...
describe Turn do
  ...
  it 'can increase the action counter' do
    turn.increase_actions
    expect(turn.return_actions).to eq 1
  end
  ...
  describe 'cycle hand' do
    ...
    it 'can cycle a hand if the actions value is zero' do
      ...
      expect(turn.return_actions).to eq 3
    end
  end
end
